...
OAUTH_PROVIDERS = [{
    ...
    'icon':'fa-lock',
        'remote_app': {
            'api_base_url':'https://api.app.koverse.com/oauth2/',
            'request_token_params':{
                'scope': 'email profile'
            },
            'access_token_url':'https://api.app.koverse.com/oauth2/token',
            'authorize_url':'https://api.app.koverse.com/oauth2/auth',
